...
const slideshowImages = [
  ...
  {
    src: EVENT_IMAGES.itfest.itfest1,
  ...
  {
    src: EVENT_IMAGES.digitalHorizon.SyangjaMain,
  ...
  {
    src: EVENT_IMAGES.digitalHorizonPalpa.palpamain,
...
const events = [
  ...
  },
  {
    ...
    location: "Chitwan",
    participants: 50,
    image: EVENT_IMAGES.itfest.itfest1,
    ...
    gallery: [
      EVENT_IMAGES.itfest.itfest1,
      EVENT_IMAGES.itfest.itfest2,
      EVENT_IMAGES.itfest.itfest3,
      EVENT_IMAGES.itfest.itfest4,
      EVENT_IMAGES.itfest.itfest5,
    ],
  },
  {
    id: 4,
    ...
    participants: 150,
    image: EVENT_IMAGES.digitalHorizon.SyangjaMain,
...
EVENT_IMAGES.digitalHorizon.Syangja5,
EVENT_IMAGES.digitalHorizon.Syangja6,
EVENT_IMAGES.digitalHorizon.Syangja7,
EVENT_IMAGES.digitalHorizon.Syangja8,
EVENT_IMAGES.digitalHorizon.Syangja9,
EVENT_IMAGES.digitalHorizon.Syangja10,
EVENT_IMAGES.digitalHorizon.Syangja11,
EVENT_IMAGES.digitalHorizon.Syangja12,
  ...
  },
  {
    ...
    gallery: [
      ...
      EVENT_IMAGES.digitalHorizonPalpa.palpa4,
      EVENT_IMAGES.digitalHorizonPalpa.palpa4,
      EVENT_IMAGES.digitalHorizonPalpa.palpa5,
      EVENT_IMAGES.digitalHorizonPalpa.palpa6,
      EVENT_IMAGES.digitalHorizonPalpa.palpa7,
      EVENT_IMAGES.digitalHorizonPalpa.palpa8,
      EVENT_IMAGES.digitalHorizonPalpa.palpa9,
