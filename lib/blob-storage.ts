...
Syangja12: `${BLOB_BASE_URL}/digitalhorizonsyangja/12.png`,
  ...
  digitalHorizonPalpa: {
    palpamain:`${BLOB_BASE_URL}/digitalhorizonpalpa/palpamain.png`,
    main: `${BLOB_BASE_URL}/digitalhorizon/main.png`,
    palpa1: `${BLOB_BASE_URL}/digitalhorizonpalpa/13.png`,
    palpa2: `${BLOB_BASE_URL}/digitalhorizonpalpa/14.png`,
    palpa3: `${BLOB_BASE_URL}/digitalhorizonpalpa/15.png`,
    palpa4: `${BLOB_BASE_URL}/digitalhorizonpalpa/16.png`,
    palpa5: `${BLOB_BASE_URL}/digitalhorizonpalpa/17.png`,
    palpa6: `${BLOB_BASE_URL}/digitalhorizonpalpa/18.png`,
    palpa7: `${BLOB_BASE_URL}/digitalhorizonpalpa/19.png`,
    palpa8: `${BLOB_BASE_URL}/digitalhorizonpalpa/20.png`,
    palpa9: `${BLOB_BASE_URL}/digitalhorizonpalpa/21.png`,
    palpa10: `${BLOB_BASE_URL}/digitalhorizonpalpa/22.png`,
    palpa11: `${BLOB_BASE_URL}/digitalhorizonpalpa/23.png`,
